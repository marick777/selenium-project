...
public class T5_getText_getAttributes_Practice {
    public static void main(String[] args) {
        ...
        if (actualHeaderTest.equals(expectedHeaderText)){
            ...
            System.err.println("Header text verification FAIL!!!");
        }
        ...
        if(actualPlaceHolder.equals(expectedPlaceHolder)){
            ...
            System.err.println("Placeholder attribute verification FAIL!!!");
        }
