...
public class T3_cssSelector {
    public static void main(String[] args) {
        ...
        // Locate loginButton using class attribute's value
        //WebElement loginButton = driver.findElement(By.className("loginAsDriver-btn"));


        //                                tagName[attribute='value']

        //Locate loginButton using cssSelector using type attribute's value
        //WebElement loginButton = driver.findElement(By.cssSelector("input[type='submit']"));

        //Locate loginButton using cssSelector using class attribute's value
        //WebElement loginButton = driver.findElement(By.cssSelector("input[class='loginAsDriver-btn']"));

        //Locate loginButton using cssSelector using value attribute's value
